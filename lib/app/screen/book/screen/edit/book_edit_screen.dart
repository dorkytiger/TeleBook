...
class BookEditScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bookStore = context.read<BookStore>();

    return ChangeNotifierProvider.value(
      value: BookEditController(bookId: bookId, bookStore: bookStore),
      child: BookEditContent(),
    );
  }
}

class BookEditContent extends StatelessWidget {
  const BookEditContent({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<BookEditController>(
              ...
              return Column(
                ...
                children: [
                  ListTile(
                    ...
                    leading: CustomImageLoader(localUrl: imagePath),
                    title: Text(
                      "第 ${index + 1} 页",
