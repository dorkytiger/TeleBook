...
import 'package:wo_nas/app/modules/book/widget/book_bottom_widget.dart';
import 'package:wo_nas/app/modules/book/widget/book_card_widget.dart';
import 'package:wo_nas/app/modules/book/widget/book_empty_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
          ...
          body: RefreshIndicator(
              child: Obx(() => controller.bookList.isNotEmpty
                  ? GridView.builder(
